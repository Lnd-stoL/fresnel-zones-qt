...
public:
    ...
    void setupUi(QMainWindow *PhasePlateWindow)
    {
        ...
        sizePolicy2.setHeightForWidth(progressBar_intensity->sizePolicy().hasHeightForWidth());
        progressBar_intensity->setSizePolicy(sizePolicy2);
        ...
        sizePolicy6.setHeightForWidth(widget_spiralGraph->sizePolicy().hasHeightForWidth());
        widget_spiralGraph->setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(pushButton_Back->sizePolicy().hasHeightForWidth());
        pushButton_Back->setSizePolicy(sizePolicy7);
...
"padding-right:5%"));
        ...
        sizePolicy7.setHeightForWidth(pushButton_Back_2->sizePolicy().hasHeightForWidth());
        pushButton_Back_2->setSizePolicy(sizePolicy7);
