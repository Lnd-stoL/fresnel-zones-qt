...
public:
    ...
    void setupUi(QMainWindow *PhasePlateWindow)
    {
        ...
        progressBar_intensity->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        frame_8->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        frame_9->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        radioButton_simplePlate->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        radioButton_stagingPlate->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        radioButton_lensPlate->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        radioButton_flatLensPlate->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        ...
        frame_10->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
...
"padding-right:5%"));
    ...
    void retranslateUi(QMainWindow *PhasePlateWindow)
    {
        ...
        label_3->setText(QApplication::translate("PhasePlateWindow", "Intensity at the point of observation", 0));
        label_2->setText(QApplication::translate("PhasePlateWindow", "Type of the phase plate:", 0));
        ...
        label_4->setText(QApplication::translate("PhasePlateWindow", "Half-wavelength", 0));
        label_5->setText(QApplication::translate("PhasePlateWindow", "Stepwise", 0));
        label_6->setText(QApplication::translate("PhasePlateWindow", "Plano-convex lens", 0));
        label_7->setText(QApplication::translate("PhasePlateWindow", "Flat Fresnel lens", 0));
        label_8->setText(QApplication::translate("PhasePlateWindow", "Amplitude at the axis", 0));
        pushButton_Back->setText(QApplication::translate("PhasePlateWindow", "Exit", 0));
        label->setText(QApplication::translate("PhasePlateWindow", "Phase plate", 0));
        pushButton_Next->setText(QApplication::translate("PhasePlateWindow", "Menu", 0));
    } // retranslateUi
