...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ZonesGraph_t, stringdata) + ofs \
...
const QMetaObject ZonesGraph::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_ZonesGraph.data,
      qt_meta_data_ZonesGraph,  qt_static_metacall, 0, 0}
};
