...
"padding-bottom:15%"));
        ...
        widget_2->setStyleSheet(QStringLiteral("image: url(:/cmc-logo.svg);"));
        ...
        widget_5->setStyleSheet(QStringLiteral("image: url(:/sanya.jpg);"));
        ...
        widget_4->setStyleSheet(QStringLiteral("image: url(:/lenya.jpg);"));
